...
class EncryptionConfigTest extends VisionSpec {
  ...
  it should "return salt value" in {
    EncryptionConfig.salt shouldEqual "$2a$10$vI8aWBnW3fID.ZQ4/zo1G.q1lRps.9cGLcZEiGDMVr5yUP1KUOYTa"
  }

  it should "return secret key value" in {
    EncryptionConfig.secretKey shouldEqual "asdf12345fdsa0987as7d7991823791d1asd"
  }
